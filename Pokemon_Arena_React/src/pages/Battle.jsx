          ...
          <main className="flex justify-center">
            <div className="max-w-2xl pokemon-card">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="flex flex-col items-center justify-center p-6 text-white transition-shadow rounded-lg shadow-lg cursor-pointer bg-gradient-to-r from-red-500 to-red-600 hover:shadow-xl" onClick={joinQueue}>
